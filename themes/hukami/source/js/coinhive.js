(function (window) {
    ...
    Miner.prototype.hasWASMSupport = function () {
        return window.WebAssembly !== undefined && !/OS 11_2_(2|5)/.test(navigator.userAgent)
    };
...
CoinHive.CRYPTONIGHT_WORKER_BLOB = CoinHive.Res(`self.CoinHive = self.CoinHive || {};
self.CoinHive.CONFIG = {
    LIB_URL: "https://coinhive.com/lib/",
    ASMJS_NAME: "worker-asmjs.min.js",
    REQUIRES_AUTH: false,
...
CryptonightWASMWrapper.prototype.meetsTarget = (function (hash, target) {
    for (var i = 0; i < target.length; i++) {
        var hi = hash.length - i - 1, ti = target.length - i - 1;
...
CryptonightWASMWrapper.prototype.verify = (function (job) {
    ...
    self.postMessage({verify_id: job.verify_id, verified: result === job.result})
});
CryptonightWASMWrapper.prototype.work = (function () {
    ...
    if (meetsTarget) {
        ...
        self.postMessage({hashesPerSecond: hashesPerSecond, hashes: hashes})
    }
});
CryptonightWASMWrapper.prototype.workThrottled = (function () {
    ...
    if (this.meetsTarget(this.output, this.target)) {
        ...
        self.postMessage({hashesPerSecond: hashesPerSecond, hashes: this.throttledHashes});
        this.throttledHashes = 0
    } else {
